...
package com.esri.solutions.flexviewer.widgets.kmlparser.kml
{
    ...
    import com.esri.solutions.flexviewer.widgets.kmlparser.atom.Author;
	...
	*/
	public class Feature extends KmlObject
	{
		...
		private var _link: com.esri.solutions.flexviewer.widgets.kmlparser.atom.Link::Link;
		...
		*/	
		public function Feature(x:XMLList)
		{
			...
			if (ParsingTools.nullCheck(this.x.atom::link) != null) {
				this._link = new com.esri.solutions.flexviewer.widgets.kmlparser.atom.Link::Link(this.x.atom::link);
			}
		...
		*/	
		public function get link(): com.esri.solutions.flexviewer.widgets.kmlparser.atom.Link
		{	
			return this._link;
		}
